                                    ...
                                    <div class="col-md-12 col-xl-8">
                                        <div class="card sale-card">
                                            ...
                                            <div class="card-block">
                                                <div id="sales-analytics" class="chart-shadow" style="height:380px">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="card-block">
                                                <div class="row">
                                                    ...
                                                    <div class="col-xl-3 col-md-6">
                                                        ...
                                                        <div class="progress">
                                                            <div class="progress-bar bg-c-green" style="width:85%">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-xl-3 col-md-6">
                                                        ...
                                                        <div class="progress">
                                                            <div class="progress-bar bg-c-yellow" style="width:45%">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="latest-update-box">
                                                        <div class="row p-t-20 p-b-30">
                                                            ...
                                                            <div class="col p-l-5">
                                                                ...
                                                                <p class="text-muted m-b-0">Lorem ipsum dolor sit amet,
                                                                    <a href="#!" class="text-c-blue"> More</a></p>
                                                            </div>
                                                        </div>
                                                        <div class="row p-b-30">
                                                            <div class="col-auto text-right update-meta p-r-0">
                                                        ...
                                                        <div class="row p-b-30">
                                                            ...
                                                            <div class="col p-l-5">
                                                                ...
                                                                <p class="text-muted m-b-0">Lorem ipsum dolor sit ipsum
                                                                    amet, <a href="#!" class="text-c-green"> More</a>
                                                                </p>
                                                            </div>
                                                        </div>
                                                        <div class="row p-b-30">
                                                            ...
                                                            <div class="col p-l-5">
                                                                ...
                                                                <p class="text-muted m-b-0">Lorem ipsum dolor sit amet,
                                                                    <a href="#!" class="text-c-red"> More</a></p>
                                                            </div>
                                                        </div>
                                                        <div class="row p-b-30">
                                                            <div class="col-auto text-right update-meta p-r-0">
                                                    ...
                                                    <table class="table table-hover m-b-0">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td><label class="label label-danger">Out Stock</label>
                                                                </td>
                                                                <td>
                                                                    <a href="#!"><i
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><label class="label label-success">In Stock</label>
                                                                </td>
                                                                <td>
                                                                    <a href="#!"><i
                                                                            class="fa fa-star f-12 text-c-yellow"></i></a>
